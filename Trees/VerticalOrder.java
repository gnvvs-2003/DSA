...
// Same Horizontal point : vertical points
// x: Horizontal position i.e verticals
// y: Vertical position i.e horizontals i.e levels
// x increases next iteration for next vertical line
// y increases => depth increases => each y iterates next node in same horizontal position
// root node positions : (x,y) = (0,0)
// left child : x = x-1 y = y+1
// right child : x = x+1 y = y+1

// Mapping <vertical,(Mapping<horizontal>,data)>

/*
 * for verticalPosition : vertical
 *      for horizontalMappings : Mapping<horizontal>,data
 *          out<<data>>
 */
